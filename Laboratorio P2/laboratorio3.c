#include <stdio.h>
/* Este programa crea un apuntador de tipo entero ue apunta al inicio de un arreglo. */
int main () {
    short arr[5], *apArr;
    apArr = &arr[0];
// imprime la dirección de memoria del arreglo en la posición [0]
    printf("Dirección del arreglo en la primera posición: %x\n",&arr[0]);
// imprime la dirección de memoria del arreglo (el nombre del arreglo es un apuntador)
